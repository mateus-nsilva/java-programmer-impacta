...
public class EstruturaWhile03 {
	/*
	 * Nesse programa, o usuário fornece uma certa quantidade de números.
	 * A entrada de dados termina quando o usuário digitar o número 0.
	 * 
	 * No final, o programa deve mostrar a soma e a quantidade de números informados.
	 */
